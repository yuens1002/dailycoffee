...
if($_POST)
{
    $to_Email       = "info@dailycoffeetea.co"; //Replace with recipient email address
    $subject        = 'WebMail Message'; //Subject line for emails
    ...
    */
    $headers = 'From: info@dailycoffeetea.co' . "\r\n" .
